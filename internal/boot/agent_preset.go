...
func CoreProviderToolNames() []string {
	return []string{
		...
		"compress",
		"use_capability",
		// La busqueda por significado va a la vista y no detras del proxy: bash
		// deja el grep a un paso, asi que esconderla la volveria la opcion cara
		// y el modelo elegiria siempre la de texto.
		"code_search",
		"git_commit_search",
	}
}
