...
var English = Messages{
	...
	ChatToolOutputOn:                       "tool output shown (Ctrl+T)",
	ChatToolOutputOff:                      "tool output hidden (Ctrl+T)",
...
Usage:
  ...
  reasonix auth <login|status|logout> [openai]          sign in to a subscription-backed provider
